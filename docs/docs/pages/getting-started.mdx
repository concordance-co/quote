...
## Intro
Concordance is a modified inference engine that allows you to ergonomically build inference-time interventions for LLMs. You can visit the repo on github [here](https://github.com/concordance-co/quote).
